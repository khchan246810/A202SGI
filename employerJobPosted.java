...
public class employerJobPosted extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_employer_job_posted);
        ...
        home.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view){
                Intent intent=new Intent(employerJobPosted.this, employersJobPostings.class);
        ...
        profilepage.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view){
                Intent intent=new Intent(employerJobPosted.this,profile_page.class);
                startActivity(intent);
            }
        });
        ...
        job_icon.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view){
                Intent intent=new Intent(employerJobPosted.this,employerJobPosted.class);
                startActivity(intent);
            }
        });
        ...
        accept.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String notificationText = "Your job is being accepted!";
                ...
                NotificationCompat.Builder mbuilder = new NotificationCompat.Builder(getApplicationContext(), CHANNEL_ID)
                        ...
                        .setVibrate(vibe)
                        .setContentTitle("Dutch Lady accepts your application.")
        ...
        reject.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String notificationText = "Your job is being rejected!";
                //String additionalText = "For something.";//
                //String newone = "Help!!!";//
                ...
                NotificationCompat.Builder mbuilder = new NotificationCompat.Builder(getApplicationContext(), CHANNEL_ID)
                        ...
                        .setSound(notificationsound)
                        .setVibrate(vibe)
                        .setContentTitle("Dutch Lady rejects your application.")
                        .setStyle(new NotificationCompat.BigTextStyle().bigText(notificationText));
                //.setStyle(new NotificationCompat.BigTextStyle().bigText(notificationText + "\n\n" + additionalText + "\n\n" + newone));//
        ...
        cancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String notificationText = "Your job is being cancelled!";
                //String additionalText = "For something.";//
                //String newone = "Help!!!";//
                ...
                NotificationCompat.Builder mbuilder = new NotificationCompat.Builder(getApplicationContext(), CHANNEL_ID)
                        ...
                        .setSound(notificationsound)
                        .setVibrate(vibe)
                        .setContentTitle("Club 21 cancels your application.")
                        .setStyle(new NotificationCompat.BigTextStyle().bigText(notificationText));
                //.setStyle(new NotificationCompat.BigTextStyle().bigText(notificationText + "\n\n" + additionalText + "\n\n" + newone));//
